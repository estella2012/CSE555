...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # MNIST dataset
    #
    transform_train = transforms.Compose([transforms.RandomCrop(32, padding=4),transforms.Grayscale(3),transforms.RandomHorizontalFlip(),transforms.ToTensor()])

    transform_val = transforms.Compose([transforms.Grayscale(3),transforms.ToTensor()])
